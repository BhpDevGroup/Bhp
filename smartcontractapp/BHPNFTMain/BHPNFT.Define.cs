    ...
    public partial class HashPowerContract : SmartContract 
    {
        ...
        public class Asset
        {
            public Asset()
            {
                ...
                ownershipStartDate = 1555430400; //所有权开始日期
                basicHashPowerAmount = 0; //基础算力
                basicHashPowerExpiryDate = 1650124800; //基础算力有效日期
                floatingHashPowerAmount = 0; //活期上浮
                floatingHashPowerExpiryDate = 1650124800;
                regularHashPowerAmount = 0; //定期上浮
                regularHashPowerExpiryDate = 1650124800;
                uptoStdHashPowerAmount = 0; //达标上浮
                uptoStdHashPowerExpiryDate = 1650124800;
                unLockDate = 1650124800; //定期解锁时间
